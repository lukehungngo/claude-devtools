...
vi.mock("../../../parser/session-discovery.js", () => ({
  discoverSessions: vi.fn(() => [
    { id: "s1", startTime: new Date(Date.now() - 3_600_000).toISOString(), lastModified: new Date().toISOString(), path: "/tmp/s1.jsonl", projectHash: "proj-a", eventCount: 50, subagentCount: 0 },
    { id: "s2", startTime: new Date(Date.now() - 86_400_000 * 3).toISOString(), lastModified: new Date(Date.now() - 86_400_000 * 3).toISOString(), path: "/tmp/s2.jsonl", projectHash: "proj-a", eventCount: 30, subagentCount: 0 },
    { id: "s3", startTime: new Date(Date.now() - 86_400_000 * 10).toISOString(), lastModified: new Date(Date.now() - 86_400_000 * 10).toISOString(), path: "/tmp/s3.jsonl", projectHash: "proj-b", eventCount: 20, subagentCount: 0 },
  ]),
}));
