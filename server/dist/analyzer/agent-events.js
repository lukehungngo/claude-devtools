...
export function getAgentEvents(sessionInfo, agentId) {
    ...
    if (agentId === "main") {
        ...
        const subagentPath = join(projectsDir, sessionInfo.projectHash, sessionInfo.id, "subagents", `agent-${agentId}.jsonl`);
