...
function makeSessionInfo(lastModifiedDate, overrides = {}) {
    return {
...
function makeAssistantEvents(inputTokens, outputTokens) {
    return [
        {
            type: "assistant",
            uuid: "a1",
...
beforeEach(() => {
    ...
    let fileCounter = 0;
    mockedStatSync.mockImplementation(() => ({ size: ++fileCounter * 1000 }));
});
describe("aggregateCosts", () => {
    ...
    it("includes sessions within 24h window", () => {
        ...
        mockedParseJsonlIncremental.mockReturnValue({ events: makeAssistantEvents(1000, 500), newOffset: 500 });
    ...
    it("includes sessions within 7d window but not 24h", () => {
        ...
        mockedParseJsonlIncremental.mockReturnValue({ events: makeAssistantEvents(2000, 1000), newOffset: 500 });
    ...
    it("aggregates costs across multiple sessions", () => {
        ...
        mockedParseJsonlIncremental
            .mockReturnValueOnce({ events: makeAssistantEvents(1000, 500), newOffset: 500 })
            .mockReturnValueOnce({ events: makeAssistantEvents(2000, 1000), newOffset: 500 });
    ...
    it("handles sessions with no assistant events (zero cost)", () => {
        ...
        mockedParseJsonlIncremental.mockReturnValue({ events: [], newOffset: 0 });
...
//# sourceMappingURL=cost-aggregator.test.js.map