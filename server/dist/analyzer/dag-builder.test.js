...
describe("buildAgentDAG", () => {
    it("always creates a main node", () => {
        const dag = buildAgentDAG([makeAssistantEvent()], new Map(), new Map());
    ...
    it("creates subagent nodes for each entry in subagentEvents", () => {
        ...
        const dag = buildAgentDAG([makeAssistantEvent()], subagentEvents, subagentMeta);
    ...
    it("uses 'unknown' type when subagentMeta is missing", () => {
        ...
        const dag = buildAgentDAG([makeAssistantEvent()], subagentEvents, new Map() // no meta
        );
