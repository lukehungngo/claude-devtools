...
function makeAssistantEvent(uuid, timestamp) {
    return {
        type: "assistant",
        uuid,
        timestamp,
...
function makeUserEvent(uuid, timestamp) {
    return {
        type: "user",
        uuid,
        timestamp,
...
function makeProgressEvent(uuid, timestamp) {
    return {
        type: "progress",
        uuid,
        timestamp,
...
function makeQueueEvent(uuid, timestamp) {
    return {
...
//# sourceMappingURL=agent-events.test.js.map