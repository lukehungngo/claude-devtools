...
function isWithinCwd(resolvedCwd, resolvedTarget) {
    // Current (buggy) implementation from routes.ts line 203
    return resolvedTarget.startsWith(resolvedCwd);
}
function isWithinCwdFixed(resolvedCwd, resolvedTarget) {
    return (resolvedTarget.startsWith(resolvedCwd + path.sep) ||
