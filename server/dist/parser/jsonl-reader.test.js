...
describe("parseJsonlFile", () => {
    ...
    it("skips malformed lines gracefully", () => {
        ...
        writeFileSync(filePath, JSON.stringify(validEvent) + "\n" + "this is not json\n" + "{invalid json\n");
        const result = parseJsonlFile(filePath);
...
describe("parseJsonlIncremental", () => {
    ...
    it("returns empty events and same offset for non-existent file", () => {
        const result = parseJsonlIncremental("/tmp/nonexistent-12345.jsonl", 100);
...
//# sourceMappingURL=jsonl-reader.test.js.map