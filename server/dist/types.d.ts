...
export type SessionEvent = QueueOperationEvent | UserEvent | AssistantEvent | ProgressEvent | SystemEvent;
...
export type ContentItem = TextContent | ThinkingContent | ToolUseContent | ToolResultContent;
...
export type WsBroadcastMessage = WsNewEventsMessage | WsNewSessionMessage | WsPermissionRequestMessage | WsPermissionResolvedMessage | WsUserQuestionMessage | WsQuestionAnsweredMessage;
