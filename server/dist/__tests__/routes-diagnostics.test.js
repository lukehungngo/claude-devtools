...
describe("GET /api/doctor", () => {
    ...
    it("includes node version check", async () => {
        const res = await request(app).get("/api/doctor").expect(200);
        const nodeCheck = res.body.checks.find((c) => c.name === "node_version");
...
describe("GET /api/stats", () => {
    ...
    it("returns top repos by session count", async () => {
        ...
        const myApp = res.body.topRepos.find((r) => r.name === "my-app");
...
//# sourceMappingURL=routes-diagnostics.test.js.map