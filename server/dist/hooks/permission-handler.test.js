...
import { addPermissionRequest, resolvePermissionRequest, getPermissionStatus, getPendingPermissions, cleanupPermissions, } from "./permission-handler.js";
describe("permission-handler", () => {
    ...
    describe("resolvePermissionRequest", () => {
        ...
        it("returns null for unknown ID", () => {
            const resolved = resolvePermissionRequest("nonexistent-id-12345", "approved");
